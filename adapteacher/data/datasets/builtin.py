...
def register_all_fetus():
    ...
    SPLITS = {
    # Fundus
    "Drishti_GS_train": ("datasets/Fundus/Drishti_GS_train.json", "datasets/Fundus/Drishti_GS/train/image"),
    "Drishti_GS_test": ("datasets/Fundus/Drishti_GS_test.json", "datasets/Fundus/Drishti_GS/test/image"),
    "ORIGA_train": ("datasets/Fundus/ORIGA_train.json", "datasets/Fundus/ORIGA/train/image"),
    "ORIGA_test": ("datasets/Fundus/ORIGA_test.json", "datasets/Fundus/ORIGA/test/image"),
    "REFUGE_train": ("datasets/Fundus/REFUGE_train.json", "datasets/Fundus/REFUGE/train/image"),
    "REFUGE_test": ("datasets/Fundus/REFUGE_test.json", "datasets/Fundus/REFUGE/test/image"),
    "RIM_ONE_r3_train": ("datasets/Fundus/RIM_ONE_r3_train.json", "datasets/Fundus/RIM_ONE_r3/train/image"),
    "RIM_ONE_r3_test": ("datasets/Fundus/RIM_ONE_r3_test.json", "datasets/Fundus/RIM_ONE_r3/test/image"),
    "REFUGE_Valid": ("datasets/Fundus/REFUGE_Valid.json", "datasets/Fundus/REFUGE_Valid/image"),

    # Polyp
    "BKAI_test": ("datasets/Polyp/BKAI_test.json", "datasets/Polyp/BKAI/test/image"),
    "BKAI_train": ("datasets/Polyp/BKAI_train.json", "datasets/Polyp/BKAI/train/image"),
    "CVC_ClinicDB_test": ("datasets/Polyp/CVC-ClinicDB_test.json", "datasets/Polyp/CVC-ClinicDB/test/image"),
    "CVC_ClinicDB_train": ("datasets/Polyp/CVC-ClinicDB_train.json", "datasets/Polyp/CVC-ClinicDB/train/image"),
    "ETIS_LaribPolypDB_test": ("datasets/Polyp/ETIS-LaribPolypDB_test.json", "datasets/Polyp/ETIS-LaribPolypDB/test/image"),
    "ETIS_LaribPolypDB_train": ("datasets/Polyp/ETIS-LaribPolypDB_train.json", "datasets/Polyp/ETIS-LaribPolypDB/train/image"),
    "Kvasir_SEG_test": ("datasets/Polyp/Kvasir-SEG_test.json", "datasets/Polyp/Kvasir-SEG/test/image"),
    "Kvasir_SEG_train": ("datasets/Polyp/Kvasir-SEG_train.json", "datasets/Polyp/Kvasir-SEG/train/image"),

    # Lung
    "COVID_train": ("datasets/covid19/0_train.json", "datasets/covid19/0/train/images"),
    "COVID_test": ("datasets/covid19/0_test.json", "datasets/covid19/0/test/images")

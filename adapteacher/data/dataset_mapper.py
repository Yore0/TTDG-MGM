...
from adapteacher.data.node_sampling import *
...
class DatasetMapperTwoCropSeparate(DatasetMapper):
    ...
    def __init__(self, cfg, is_train=True):
        ...
        # Lvxg
        self.num_samples_boundary = cfg.DATASETS.NUM_BOUNDARY
        self.num_samples_centroid=cfg.DATASETS.NUM_CENTROID
        self.radius_centroid=cfg.DATASETS.RADIUS_CENTROID
        # fmt: on
    ...
    def __call__(self, dataset_dict):
        ...
        # Lvxg: add boundary_sampling & centroid_sampling
        # all_boundary_samples, all_centroid_samples = process_polygon_masks(dataset_dict["instances"].gt_masks, \
        #                                                                    dataset_dict["instances"].image_size[0], 
        #                                                                    dataset_dict["instances"].image_size[1],
        #                                                                    num_samples_boundary=self.num_samples_boundary,
        #                                                                    num_samples_centroid=self.num_samples_centroid,
        #                                                                    radius_centroid=self.radius_centroid)
        
        # visualize_sampling_on_mask(dataset_dict['file_name'], dataset_dict["instances"].gt_masks, all_boundary_samples, all_centroid_samples)

        # dataset_dict["graphs"] = {"boundary":all_boundary_samples, "centroid:":all_centroid_samples}
